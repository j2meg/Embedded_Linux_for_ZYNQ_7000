#!/bin/bash
# Format a microSD card for ZYBO BOARD
# ADAPTED FROM Mastering Embedded Linux Programming
# Size of partitions taked from https://github.com/jinchenglee/zybo_linux_setup_doc
...
#  1: FAT32, 512 MiB, boot flag
#  2: Linux, rest of the storage for Linux File System 
...
sudo mkfs.ext4 -L ROOT_FS ${ROOT_PART}
